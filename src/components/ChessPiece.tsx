/**
 * SVG chess pieces — exact CBurnett paths from Lichess.
 * Source: github.com/lichess-org/lila/tree/master/public/piece/cburnett
 * License: AGPL (piece artwork by Colin M.L. Burnett, CC BY-SA 3.0)
 * viewBox: 0 0 45 45
 */
...
const PIECES: Record<PieceColor, Record<PieceType, React.FC>> = {
  w: { p: WPawn, n: WKnight, b: WBishop, r: WRook, q: WQueen, k: WKing },
  b: { p: BPawn, n: BKnight, b: BBishop, r: BRook, q: BQueen, k: BKing },
};
...
const ChessPiece: React.FC<Props> = ({ type, color, style, className }) => {
  const PieceSVG = PIECES[color]?.[type];
